...
import { BarChart3, Calendar, Clapperboard, Contact, HandCoins, Inbox, Loader2, LogOut, Mail, MessageSquare, Newspaper, PanelTop, ScrollText, UserPlus, Video } from "lucide-react";
