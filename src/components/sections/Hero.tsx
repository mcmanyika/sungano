...
import type { HeroVariant } from "@/types/landing-sections";
...
export function Hero({
  ...
  const backgroundSrc = isBanner
    ? bannerUrl.trim() || "/images/banner1.png"
    : "/images/banner2.png";
            ...
            <div className="grid items-center gap-8 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:gap-10 xl:gap-12">
              ...
              >
                ...
                >
                  ...
                  <br />
                  <span className="text-neutral-950">Constitutional</span>{" "}
                  Democracy
                </motion.h1>
